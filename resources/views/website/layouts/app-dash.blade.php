...
<head>
    ...
    <link href="{{ asset('assets/css/front/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/front/bootstrap_limitless.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/front/dash-layout.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/front/components.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/front/colors.min.css') }}" rel="stylesheet" type="text/css">
    <!-- /global stylesheets -->
...
<div class="page-content">
    ...
    <div class="sidebar sidebar-dark sidebar-main sidebar-expand-md">
        ...
        <!-- /sidebar mobile toggler -->
        <!-- Sidebar content -->
    @include('website.regions.sidebar')
    <!-- /sidebar content -->
    </div>
    <!-- /main sidebar -->
