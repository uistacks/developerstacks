<div class="profile-cover border-bottom-2 border-bottom-danger">
    <div class="profile-cover-img" style="background-image: url({{ url('/') }}/assets/images/placeholders/cover.jpg)"></div>
    <div class="media align-items-center text-center text-md-left flex-column flex-md-row m-0">
        ...
        <div class="ml-md-3 mt-2 mt-md-0">
            <ul class="list-inline list-inline-condensed mb-0">
                <li class="list-inline-item"><a href="#" class="btn btn-light border-transparent legitRipple"><i class="icon-file-picture mr-2"></i> Cover image</a></li>
                <li class="list-inline-item"><a href="#" class="btn btn-light border-transparent legitRipple"><i class="icon-file-stats mr-2"></i> Statistics</a></li>
            </ul>
        </div>
    </div>
</div>