@if($latestStores->count() > 0)
    @foreach($latestStores as $key1 => $item)
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <div class="thumbnail result-info">
                ...
                <div class="caption">
                    ...
                    <ul>
                        <li> <i class="fa fa-globe" aria-hidden="true"></i><span>{{isset($item) ? str_limit($item->trans->location,25) : ""}}</span></li>
                        <li>
