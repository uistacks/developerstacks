    ...
    public function boot()
    {
        ...
        */
        ...
        $this->mergeConfigFrom(
            __DIR__.'/config/tutorials.php', 'tutorials'
        );

        // Publish configration if we need to customize configration instead of default one. 
        $this->publishes([
            __DIR__.'/config/tutorials.php' => config_path('tutorials.php'),
        ], 'config');
        ...
        */
        ...
        $this->loadViewsFrom(__DIR__.'/views', 'Tutorials');

        // Publish views if we need to customize views instead of default one. 
        $this->publishes([
            __DIR__.'/views' => base_path('resources/views/vendor/tutorials'),
        ], 'views');
        ...
        */
        ...
        $this->publishes([
            __DIR__.'/Lang/' => resource_path('lang/vendor/tutorials'),
        ], 'lang');
        ...
        */
        $this->publishes([
            __DIR__.'/Public' => public_path('vendor/tutorials'),
        ], 'public');
