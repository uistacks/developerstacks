...
class Thread extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['project_id', 'subject', 'bid_id'];
...
//        return $this->hasMany(Models::classname(Message::class), 'thread_id', 'id');
        return $this->hasMany(\UiStacks\Messages\Models\Message::class, 'thread_id', 'id');
    }

    /**
     * Returns the latest message from a thread.
     *
     * @return null|\Cmgmyr\Message\Models\Message
     */
    ...
    {
        return $this->hasMany(\UiStacks\Messages\Models\Participant::class, 'thread_id', 'id');
    }
...
//        return $this->belongsToMany(Models::classname('User'), Models::table('participants'), 'thread_id', 'user_id');
        return $this->belongsToMany('\UiStacks\Users\Models\User', '\UiStacks\Messages\Models\Participant', 'thread_id', 'user_id');
    }
...
//            $this->creatorCache = $firstMessage ? $firstMessage->user : Models::user();
            $this->creatorCache = $firstMessage ? $firstMessage->user : \UiStacks\Users\Models\User::class;
        }
...
//        $threadsTable = Models::table('threads');
    ...
    public function addParticipant($userId)
    {
        ...
        collect($userIds)->each(function ($userId) {
            \UiStacks\Messages\Models\Participant::firstOrCreate([
                'user_id' => $userId,
                'thread_id' => $this->id,
            ]);
...
//            ]);
    ...
    public function removeParticipant($userId)
    {
        ...
        \UiStacks\Messages\Models\Participant::where('thread_id', $this->id)->whereIn('user_id', $userIds)->delete();
    }
    ...
    public function participantsString($userId = null, $columns = ['name'])
    {
        ...
        $participantsTable = 'participants';
        $usersTable = 'users';
        $userPrimaryKey = \UiStacks\Users\Models\User::getKeyName();
