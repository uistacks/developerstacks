        ...
        <form action="" method="GET" class="form-inline">
        	...
        	@php
		  	...
		  	@include('Core::fields.input_text', [
                'field_name' => 'name',
                'name' => trans('Categories::categories.category'),
                'value' => $nameValue,
                'placeholder' => ''
            ])
            ...
            @include('Core::fields.select', [
		  	...
		  	<a href="{{ action('\Uistacks\Categories\Controllers\CategoriesController@index')}}" class="btn btn-default">{{ trans('Core::operations.reset') }}</a>
		</form>
