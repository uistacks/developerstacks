                ...
                <form action="{{ $action }}" method="POST" role="form" >
                    ...
                    <div class="col-md-3 sidbare">
                        ...
                        <div class="form-group {{ $errors->has('main_image_id') ? 'has-error': '' }}" style="text-align: center;">
                            ...
                            <a data-toggle="modal" data-target="#inno_media_modal" href="javascript:void(0)" media-data-button-name="{{ trans('Core::operations.select') }} Image" media-data-field-name="main_image_id" media-data-required>
