...
//
    ...
    {
//        return $this->hasOne('\UiStacks\Qas\Models\QasTrans', 'blog_id')->where('lang', Lang::getlocale())->select("*");
        return $this->hasOne('\UiStacks\Qas\Models\QATrans', 'qna_id')->where('lang', Lang::getlocale())->select("*");
    }
/*
 * get answers count of a question
 */
    public function answersCount()
    {
        return $this->hasMany('\UiStacks\Qas\Models\QAComment', 'qna_id')->select("id");
    }
    ...
    {
        return $this->belongsTo('UiStacks\Users\Models\User', 'created_by')->select(['id','email','phone', 'name','options']);
    }
    ...
    /**
     * Scope a query to only include filterd qna name.
     *
    ...
    /**
     * Scope a query to only include filterd qna section.
     *
     * @param \Illuminate\Database\Eloquent\Builder $query
     * @return \Illuminate\Database\Eloquent\Builder
     */
    ...
    /**
     * Scope a query to only include filterd qna status.
     *
     * @param \Illuminate\Database\Eloquent\Builder $query
     * @return \Illuminate\Database\Eloquent\Builder
     */
